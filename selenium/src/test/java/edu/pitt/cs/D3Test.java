...
public class D3Test {
  ...
  public void tEST1LINKS() {
    ...
    {
      List<WebElement> elements = driver.findElements(By.xpath("//a[contains(.,\'Reset\')]"));
      assert(elements.size() > 0);
    }
    {
      WebElement element = driver.findElement(By.xpath("//a[contains(.,\'Reset\') and @href=\'/reset\']"));
      String attribute = element.getAttribute("href");
      vars.put("reset", attribute);
    }
    assertEquals("http://localhost:8080/reset",vars.get("reset").toString());
    assertThat(driver.findElement(By.xpath("//a[contains(.,\'Reset\')]")).getText(), is("Reset"));
  }
  @Test
  public void tEST2RESET() {
    driver.get("http://localhost:8080/");
    driver.manage().window().setSize(new Dimension(774, 827));
  ...
  public void tEST4LISTING() {
    driver.get("http://localhost:8080/");
    driver.manage().window().setSize(new Dimension(768, 827));
    driver.findElement(By.linkText("Catalog")).click();
    {
    ...
    assertThat(driver.findElement(By.xpath("//div[@id=\'listing\']/ul/li[3][contains(., \'ID 3. Mistoffelees\')]")).getText(), is("ID 3. Mistoffelees"));
  }
  @Test
  ...
  public void tEST6RENT() {
    ...
    assertThat(driver.findElement(By.xpath("//div[@id=\'listing\']/ul/li[1][contains(., \'Rented out\')]")).getText(), is("Rented out"));
    assertThat(driver.findElement(By.xpath("//div[@id=\'listing\']/ul/li[2][contains(., \'ID 2. Old Deuteronomy\')]")).getText(), is("ID 2. Old Deuteronomy"));
    assertThat(driver.findElement(By.xpath("//div[@id=\'listing\']/ul/li[3][contains(., \'ID 3. Mistoffelees\')]")).getText(), is("ID 3. Mistoffelees"));
    assertThat(driver.findElement(By.xpath("//*[@id=\"rentResult\" and contains(., \'Success!\')]")).getText(), is("Success!"));
  }
  @Test
  public void tEST7RETURN() {
    ...
    assertThat(driver.findElement(By.xpath("//div[@id=\'listing\']/ul/li[1][contains(., \'ID 1. Jennyanydots\')]")).getText(), is("ID 1. Jennyanydots"));
    assertThat(driver.findElement(By.xpath("//div[@id=\'listing\']/ul/li[2][contains(., \'ID 2. Old Deuteronomy\')]")).getText(), is("ID 2. Old Deuteronomy"));
    assertThat(driver.findElement(By.xpath("//div[@id=\'listing\']/ul/li[3][contains(., \'ID 3. Mistoffelees\')]")).getText(), is("ID 3. Mistoffelees"));
    assertThat(driver.findElement(By.xpath("//*[@id=\"returnResult\" and contains(., \'Success!\')]")).getText(), is("Success!"));
  }
  @Test
  ...
  //   driver.get("http://localhost:8080/");
  //   driver.manage().window().setSize(new Dimension(768, 831));
  //   js.executeScript("document.cookie = \"1=true\";document.cookie = \"2=false\";document.cookie = \"3=false\";");
  //   driver.findElement(By.linkText("Greet-A-Cat")).click();
  //   assertThat(driver.findElement(By.xpath("//div[@id=\'greeting\']/h4[contains(.,\'Meow!Meow!\')]")).getText(), is("Meow!Meow!"));
  // }
}